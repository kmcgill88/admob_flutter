...
class AdmobRequestBuilderFactory(private val targetingInfo: HashMap<*, *>?){
    ...
    fun createAdRequestBuilder(): AdRequest.Builder? {
        ...
        if (birthday != null) {
            if (birthday !is Long) Log.w(TAG, "targetingInfo birthday: expected a long integer") else builder.setBirthday(Date((birthday as Long?)!!))
        }
